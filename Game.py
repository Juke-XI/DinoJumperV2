...
from Ozadje import Ozadje
from Ovire import Kaktus, Zmaj
...
def gameover(screen):
	...
	gameover_img = pygame.image.load('./pics/others/gameover.png').convert_alpha()
	gameover_rect = gameover_img.get_rect()
	gameover_rect.left, gameover_rect.top = WIDTH//3, int(HEIGHT/2.4)
	screen.blit(gameover_img, gameover_rect)
	restart_img = pygame.image.load('./pics/others/ricardo.png').convert_alpha()
...
def main():
	...
	pygame.mixer.init()
	pygame.mixer.music.load("./music/MUI.mp3")
	pygame.mixer.music.set_volume(0.6)
	pygame.mixer.music.play(-1)
	font = pygame.font.Font('./font/simkai.ttf', 20)
	dinosaur = Dinosaur(WIDTH, HEIGHT)
	scene = Ozadje(WIDTH, HEIGHT)
